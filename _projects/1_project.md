...
{% include figure.html path="/assets/img/shell_irl.jpg", title=1 class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="/assets/img/tables.jpg", title=2 class="img-fluid rounded z-depth-1" %}
